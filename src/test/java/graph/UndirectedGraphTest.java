...
public class UndirectedGraphTest {
    ...
    public void addAndReturnEdges() {
        ...
        Assert.assertTrue(graph.getGraphStructure().get(3).contains(fourThreeEdge));
    ...
    public void getPath() {
        ...
        Assert.assertTrue(path.get(0).getVertexA() == 2
                && path.get(0).getVertexB() == 3
                && path.get(1).getVertexA() == 1
                && path.get(1).getVertexB() == 2);
    }
